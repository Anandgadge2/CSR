      ...
      <div className="px-6 pt-5 pb-0">
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            ...
            <p className="text-[11px] font-mono text-slate-400 mt-0.5">{role.code}</p>
          </div>
        </div>

        {/* Tabs */}
        <div className="flex items-center gap-0 mt-4 border-b border-slate-100/80 -mx-6 px-6" role="tablist">
          {TABS.map((tab) => {
            const Icon = tab.icon;
            ...
            return (
              <button
                ...
                className={cn(
                  "flex items-center gap-1.5 px-4 py-2.5 text-xs font-semibold border-b-2 transition-all min-h-[44px]",
