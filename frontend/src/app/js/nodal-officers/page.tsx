...
export default function JSNodalOfficersPage() {
  return (
    <GovPortalLayout userRole="JOINT_SECRETARY">
      <GovPageHeader
        title="Nodal Officers"
        description="Manage nodal officers for approved projects"
        breadcrumb="Home / Nodal Officers"
      />
